...
from unistego.stream import HidingStream, UnhidingStream
import six
...
class TestStreams(unittest.TestCase):
    ...
    def test_streams(self):
        self._test_skeleton({'strategy_class': JoinersHidingStrategy },
                             {'strategy_class':JoinersUnhidingStrategy, })
        
    def test_comressed(self):
        self._test_skeleton({'strategy_class': JoinersHidingStrategy, 'compress_class':Zlib, 'level':9 },
                             {'strategy_class':JoinersUnhidingStrategy, 'compress_class':Zlib })
        
    def test_spaces(self):
        self._test_skeleton({'strategy_class': AltSpaceHidingStrategy, 'compress_class':Zlib, 'level':9 },
